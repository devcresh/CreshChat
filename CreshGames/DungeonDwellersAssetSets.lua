...
function _G.CreshGamesDDGetSet(setKey)
    return _G.CreshGamesDungeonDwellersSets[setKey]
end

function _G.CreshGamesDDGetTexture(setKey, assetName)
...
-- Example:
-- portrait:SetTexture(CreshGamesDDGetTexture("01_Player_Portraits_Classic", "HumanPaladin"))
-- body:SetTexture(CreshGamesDDGetTexture("07_Boss_FullBody_Set_B", "DragonkinBoss"))
if CC then
    CC.Assets = CC.Assets or {}
    CC.Assets.DungeonDwellers = _G.CreshGamesDungeonDwellersSets
    if CC.RegisterModule then CC:RegisterModule("DungeonAssets", { version = CC.version, library = _G.CreshGamesDungeonDwellersSets }) end
end
